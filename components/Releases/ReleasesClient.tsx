...
>
  <button
    ...
    className={`px-4 py-1.5 rounded-md transition-all duration-200 font-semibold cursor-pointer focus:outline-none focus-visible:ring-2 focus-visible:ring-[#4169E1]/40
      ${activeRepo === "Mobile App"
        ? "text-[#4169E1] bg-[#4169E1]/10 shadow-sm"
        : "text-zinc-500 hover:bg-[#4169E1]/10 hover:text-[#4169E1] active:bg-[#4169E1]/20"}
    `}
  >
    Mobile App
  </button>
